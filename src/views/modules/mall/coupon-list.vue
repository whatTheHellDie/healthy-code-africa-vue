<template>
  <div class="mod-user">
       ...
       <span class="label-search">{{$t( '领取人' )}}</span>
      <el-form-item>
        <el-input v-model="dataForm.realname" :placeholder="$t( '领取人' )" clearable></el-input>
      </el-form-item>
       <span class="label-search">{{$t( '领取人电话' )}}</span>
      <el-form-item>
        <el-input v-model="dataForm.phone" :placeholder="$t( '领取人电话' )" clearable></el-input>
      </el-form-item>
      <div class="inb">
      <span class="label-search">{{$t( '优惠券状态' )}}</span>
      ...
      <el-table-column prop="realname" header-align="center" align="center" width="200" :label="$t( '领取人' )">
      </el-table-column>
      <el-table-column prop="phone" header-align="center" align="center" :label="$t( '领取人电话' )">
      </el-table-column>
      <el-table-column prop="amount" header-align="center" align="center" width="200" :label="$t( '优惠券金额' )">
      </el-table-column>
       <el-table-column prop="couponName" header-align="center" align="center" width="200" :label="$t( '优惠券名称' )">
      </el-table-column>
      <el-table-column prop="dueTime" header-align="center" align="center" width="200" :label="$t( '有效期' )">
      </el-table-column>
      <el-table-column prop="storeName" header-align="center" align="center" width="200" :label="$t( '优惠券状态' )">
