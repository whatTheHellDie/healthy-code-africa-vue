  ...
  <div>
    <div class="mod-demo-ueditor">
      <el-form ref="dataForm" :rules="dataRules" :model="dataForm" label-width="80px">
        ...
        <el-form-item :label="$t( '住院时间' )" prop="contentHtml">
          {{dataForm.contentHtml}}
        </el-form-item>
        <el-form-item :label="$t( '出院时间' )" prop="title">
          <el-date-picker v-model="dataForm.value" type="daterange" range-separator="-" :start-placeholder="$t( '开始日期' )" :end-placeholder="$t( '结束日期' )">
          </el-date-picker>
        </el-form-item>
        <el-form-item :label="$t( '住院病种' )" prop="contentHtml">
          {{dataForm.contentHtml}}
        </el-form-item>
        <el-form-item :label="$t( '住院医嘱' )" prop="contentHtml">
          <el-input type="textarea" v-model="dataForm.contentHtml" :rows="10"></el-input>
        </el-form-item>
        </el-form-item>
        <el-form-item>
