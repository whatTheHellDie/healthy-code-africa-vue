<template>
  ...
  <div class="mod-user">
      ...
      <div class="inb">
      <span class="label-search">{{$t( '出院时间' )}}</span>
      <el-date-picker
     ...
     <el-table-column prop="shopName" header-align="center" align="center" :label="$t( '就诊编号' )">
      ...
      <el-table-column prop="realname" header-align="center" align="center" width="200" :label="$t( '住院时间' )">
      </el-table-column>
      <el-table-column prop="phone" header-align="center" align="center" :label="$t( '住院病种' )">
      </el-table-column>
      <el-table-column prop="amount" header-align="center" align="center" width="200" :label="$t( '出院时间' )">
      </el-table-column>
       <el-table-column prop="couponName" header-align="center" align="center" width="200" :label="$t( '出院状态' )">
      </el-table-column>
      <el-table-column prop="dueTime" header-align="center" align="center" width="200" :label="$t( '出院医嘱' )">
      </el-table-column>
