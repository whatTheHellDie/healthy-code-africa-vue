  ...
  <div>
    <div class="mod-demo-ueditor">
      <el-form ref="dataForm" :rules="dataRules" :model="dataForm" label-width="80px">
        ...
        <el-form-item :label="$t( '性别' )" prop="contentHtml">
          <el-input v-model="dataForm.contentHtml" :rows="10"></el-input>
        </el-form-item>
        <el-form-item :label="$t( '年龄' )" prop="contentHtml">
          <el-input v-model="dataForm.contentHtml" :rows="10"></el-input>
        </el-form-item>
        <el-form-item :label="$t( '身份证号' )" prop="contentHtml">
          <el-input v-model="dataForm.contentHtml" :rows="10"></el-input>
        </el-form-item>
        </el-form-item>
        <el-form-item :label="$t( '床位号' )" prop="title">
        ...
        <el-form-item :label="$t( '住院时间' )" prop="title">
          <el-date-picker
      ...
      :end-placeholder="$t( '结束日期' )">
        ...
        <el-form-item :label="$t( '住院病种' )" prop="title">
          <el-select v-model="dataForm.status" :placeholder="$t('请选择')">
            <el-option v-for="item in vertifyOptions" :key="item.value" :label="item.label" :value="item.value">
            </el-option>
          </el-select>
