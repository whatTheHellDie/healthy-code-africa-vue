<template>
  ...
  <div class="mod-user">
      ...
      <el-table-column prop="phone" header-align="center" align="center" :label="$t( '身份证号' )">
      </el-table-column>
      <el-table-column prop="amount" header-align="center" align="center" width="200" :label="$t( '床位号' )">
      </el-table-column>
       <el-table-column prop="couponName" header-align="center" align="center" width="200" :label="$t( '住院时间' )">
      </el-table-column>
      <el-table-column prop="dueTime" header-align="center" align="center" width="200" :label="$t( '住院病种' )">
      </el-table-column>
      <el-table-column prop="storeName" header-align="center" align="center" width="200" :label="$t( '状态' )">
        <template slot-scope="scope">
          <el-tag  v-if="scope.row.state===0">{{$t( '入院' )}}</el-tag>
          <el-tag type="info" v-else>{{$t( '出院' )}}</el-tag>
        </template>
      </el-table-column>
