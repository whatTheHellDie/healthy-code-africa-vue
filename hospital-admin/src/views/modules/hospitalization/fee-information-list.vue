<template>
  ...
  <div class="mod-user">
      ...
      <span class="label-search">{{$t( '项目编号' )}}</span>
      <el-form-item>
        <el-input v-model="dataForm.phone" :placeholder="$t( '就诊编号' )" clearable></el-input>
      </el-form-item>
      <div class="inb">
      <span class="label-search">{{$t( '住院时间' )}}</span>
      <el-date-picker
     ...
     <el-table-column prop="shopName" header-align="center" align="center" :label="$t( '就诊编号' )">
      </el-table-column>
      <el-table-column prop="realname" header-align="center" align="center" width="200" :label="$t( '项目类别' )">
      </el-table-column>
      <el-table-column prop="phone" header-align="center" align="center" :label="$t( '药品类别' )">
      </el-table-column>
      <el-table-column prop="amount" header-align="center" align="center" width="200" :label="$t( '项目编号' )">
      </el-table-column>
       <el-table-column prop="couponName" header-align="center" align="center" width="200" :label="$t( '费用编号' )">
      </el-table-column>
      <el-table-column prop="dueTime" header-align="center" align="center" width="200" :label="$t( '价格' )">
      </el-table-column>
      <el-table-column prop="storeName" header-align="center" align="center" width="200" :label="$t( '状态' )">
        <template slot-scope="scope">
          ...
          <el-tag type="info" v-else>{{$t( '已缴费' )}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop="dueTime" header-align="center" align="center" width="200" :label="$t( '押金' )">
      </el-table-column>
