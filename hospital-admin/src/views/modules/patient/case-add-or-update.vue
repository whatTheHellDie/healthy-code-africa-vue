  ...
  <el-dialog :title="!dataForm.id ? $t( '新增' ) : $t( '修改' )" :close-on-click-modal="false" :visible.sync="visible" class="material-store-add">
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" :label-width="labelWidth">
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item :label="$t( '年龄' )" prop="realname">
            <div>{{dataForm.realname}}</div>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="$t( '出诊日期' )" prop="realname">
            <div>{{dataForm.realname}}</div>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="$t( '居住地' )" prop="realname">
            <div>{{dataForm.realname}}</div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-form-item :label="$t( '诊断' )" prop="shopName">
        <el-input v-model="dataForm.shopName" :placeholder="$t( '诊断' )"></el-input>
      </el-form-item>
      <el-form-item :label="$t( '主诉' )" prop="contacts">
        <el-input type="textarea" v-model="dataForm.contacts" :placeholder="$t( '主诉' )"></el-input>
      </el-form-item>
       <el-form-item :label="$t( '现病史' )" prop="contacts">
        <el-input type="textarea" v-model="dataForm.contacts" :placeholder="$t( '现病史' )"></el-input>
      </el-form-item>
      <el-form-item :label="$t( '既往史' )" prop="contacts">
        <el-input type="textarea" v-model="dataForm.contacts" :placeholder="$t( '既往史' )"></el-input>
      </el-form-item>
      <el-form-item :label="$t( '个人史' )" prop="contacts">
        <el-input type="textarea" v-model="dataForm.contacts" :placeholder="$t( '个人史' )"></el-input>
      </el-form-item>
      <el-form-item :label="$t( '处方' )" prop="contacts">
        <el-input type="textarea" v-model="dataForm.contacts" :placeholder="$t( '处方' )"></el-input>
      </el-form-item>
      <el-form-item :label="$t( '医嘱' )" prop="contacts">
        <el-input type="textarea" v-model="dataForm.contacts" :placeholder="$t( '医嘱' )"></el-input>
      </el-form-item>
