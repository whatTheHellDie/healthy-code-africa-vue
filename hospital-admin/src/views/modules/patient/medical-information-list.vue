<template>
  ...
  <div class="mod-user">
      ...
      <el-form-item>
        <el-input v-model="dataForm.phone" :placeholder="$t( '就诊号' )" clearable></el-input>
      </el-form-item>
      <div class="inb">
      ...
      <el-table-column prop="realname" header-align="center" align="center" :label="$t( '就诊编号' )">
      </el-table-column>
      <el-table-column prop="phone" header-align="center" align="center" :label="$t( '就诊时间' )">
      </el-table-column>
      <el-table-column prop="amount" header-align="center" align="center" :label="$t( '门诊编号' )">
      </el-table-column>
       <el-table-column prop="couponName" header-align="center" align="center" :label="$t( '病情描述' )">
      </el-table-column>
      <el-table-column prop="dueTime" header-align="center" align="center" :label="$t( '诊断名称' )">
      </el-table-column>
      <el-table-column prop="dueTime" header-align="center" align="center" :label="$t( '就诊医院' )">
      </el-table-column>
