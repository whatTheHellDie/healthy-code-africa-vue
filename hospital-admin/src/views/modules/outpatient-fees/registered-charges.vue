<template>
  ...
  <div class="mod-user">
      ...
      <el-table-column prop="phone" header-align="center" align="center" :label="$t( '性别' )">
      </el-table-column>
      <el-table-column prop="amount" header-align="center" align="center" :label="$t( '预约科室' )">
      </el-table-column>
       <el-table-column prop="couponName" header-align="center" align="center" :label="$t( '预约医生' )">
      </el-table-column>
      <el-table-column prop="dueTime" header-align="center" align="center" :label="$t( '挂号费' )">
      </el-table-column>
      ...
      <el-table-column fixed="right" header-align="center" align="center" width="180" :label="$t( '操作' )">
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="confirmPay(scope.row.id)">{{$t( '确认收费' )}}</el-button>
