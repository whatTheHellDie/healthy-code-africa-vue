<template>
  ...
  <div class="mod-user">
      ...
      <span class="label-search">{{$t( '项目名称' )}}</span>
      <el-form-item>
      ...
      <el-table-column prop="shopName" header-align="center" align="center" :label="$t( '项目名称' )">
      </el-table-column>
      <el-table-column prop="contacts" header-align="center" align="center" width="200" :label="$t( '价格' )"></el-table-column>
      <el-table-column prop="contacts" header-align="center" align="center" width="200" :label="$t( '诊疗编号' )"></el-table-column>
...
<script>
import AddOrUpdate from './treatment-items-add-or-update'
  export default {
    data() {
      return {
