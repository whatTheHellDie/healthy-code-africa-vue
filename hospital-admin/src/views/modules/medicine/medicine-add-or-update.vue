<template>
  <el-dialog :title="!dataForm.id ? $t( '新增' ) : $t( '修改' )" v-loading.fullscreen.lock="fullscreenLoading" :close-on-click-modal="false" :visible.sync="visible" class="material-store-add">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" :label-width="labelWidth">
      <el-form-item :label="$t( '药品编号' )" prop="shopName">
        <el-input v-model="dataForm.shopName" :placeholder="$t( '药品编号' )"></el-input>
      </el-form-item>
      <el-form-item :label="$t( '药品名称' )" prop="account">
        <el-input v-model="dataForm.account" :placeholder="$t( '药品名称' )"></el-input>
      </el-form-item>
      <el-form-item :label="$t( '单价' )" prop="account">
        <el-input v-model="dataForm.account" :placeholder="$t( '单价' )"></el-input>
      </el-form-item>
      <el-form-item :label="$t( '规格' )" prop="account">
        <el-input v-model="dataForm.account" :placeholder="$t( '规格' )"></el-input>
      </el-form-item>
      <el-form-item :label="$t( '库存' )" prop="account">
        <el-input v-model="dataForm.account" :placeholder="$t( '库存' )"></el-input>
      </el-form-item>
