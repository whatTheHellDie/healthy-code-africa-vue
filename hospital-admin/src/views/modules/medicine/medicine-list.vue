<template>
  ...
  <div class="mod-user">
      ...
      <span class="label-search">{{$t( '药品名称' )}}</span>
      <el-form-item>
      ...
      <el-table-column prop="shopName" header-align="center" align="center" :label="$t( '药品编号' )">
      </el-table-column>
      <el-table-column prop="contacts" header-align="center" align="center" width="200" :label="$t( '药品名称' )"></el-table-column>
      <el-table-column prop="contacts" header-align="center" align="center" width="200" :label="$t( '单价' )"></el-table-column>
      <el-table-column prop="contacts" header-align="center" align="center" width="200" :label="$t( '规格' )">
      </el-table-column>
      <el-table-column prop="contacts" header-align="center" align="center" width="200" :label="$t( '库存' )">
      </el-table-column>
