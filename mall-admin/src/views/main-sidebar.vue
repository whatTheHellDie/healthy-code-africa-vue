    ...
    <div class="site-sidebar__inner">
      <el-menu
        ...
        <el-submenu index="material">
          ...
          <el-menu-item index="commodity-manage" @click="$router.push({ name: 'commodity-manage' })">
            <icon-svg name="admin" class="site-sidebar__menu-icon"></icon-svg>
            <span slot="title">{{$t( '商品管理' )}}</span>
          </el-menu-item>
          <el-menu-item index="order-manage" @click="$router.push({ name: 'order-manage' })">
            <icon-svg name="admin" class="site-sidebar__menu-icon"></icon-svg>
            <span slot="title">{{$t( '订单管理' )}}</span>
          </el-menu-item>
          <el-menu-item index="coupon-receive-manage" @click="$router.push({ name: 'coupon-receive-manage' })">
            <icon-svg name="admin" class="site-sidebar__menu-icon"></icon-svg>
            <span slot="title">{{$t( '优惠券领取管理' )}}</span>
          </el-menu-item>
        <el-menu-item index="coupon-manage" @click="$router.push({ name: 'coupon-manage' })">
            <icon-svg name="admin" class="site-sidebar__menu-icon"></icon-svg>
            <span slot="title">{{$t( '优惠券管理' )}}</span>
          </el-menu-item>
        </el-submenu>
